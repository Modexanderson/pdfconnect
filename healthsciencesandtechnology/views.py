...
class HealthSciencesAndTechnologyView(generic.ListView):
    template_name = 'home/healthsciencesandtechnology_page.html'
    model = models.Book
    paginate_by = 10
...
class UploadBookView(generic.CreateView):
    model = models.Book
    form_class = BookForm
    success_url = reverse_lazy('healthsciencesandtechnology')
